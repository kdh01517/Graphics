...
void Context::Render() {
    if (ImGui::Begin("ui window")) {
        ...
        ImGui::DragFloat("camera pitc", &m_cameraPitch, 0.5f, -89.9f, 89.0f);
        ImGui::Separator();
        ...
        if (ImGui::CollapsingHeader("light", ImGuiTreeNodeFlags_DefaultOpen)) {
            ...
            ImGui::DragFloat("l.distance", &m_light.distance, 0.5f, 0.0f, 3000);
...
//    m_framebuffer->Bind();
    ...
    auto projection = glm::perspective(glm::radians(45.0f),
                                       (float)m_width / (float)m_height, 0.1f, 50.0f);
